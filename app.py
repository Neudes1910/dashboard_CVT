...
if uploaded_files:
    ...
    if ocorrencias:
        ...
        natureza_col = [
            c for c in df_total.columns if "NATUREZA" in c.upper()
        ][0]
        ...
        df_total = df_total[
            ...
            .astype(str)
            .str.lower()
            .isin(["escolha um item", "escolher um item."])
        ]

        meses_ordenados = (
            df_total[["MES", "MES_SORT"]]
            .drop_duplicates()
    ...
    if horas_registros:
        ...
        for _, row in meses_ordenados.iterrows():
            ...
            df_detalhado = df_detalhado[
                ~df_detalhado[col_equip]
                .astype(str)
                .str.lower()
                .isin(["nan", "não identificado", "escolha um item."])
            ]
